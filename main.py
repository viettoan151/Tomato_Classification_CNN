...
class TomatoDataset(data.Dataset):
    def __init__(self, feature_dir, transform=None):
        self.label_dataframe = pd.read_csv(feature_dir + "label.csv", header=0)
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(1, 16, 8, 1)
        self.conv2 = nn.Conv1d(16, 32, 3, 1)
        self.dropout1 = nn.Dropout2d(0.25)
        self.dropout2 = nn.Dropout2d(0.5)
        self.fc1 = nn.Linear(4016, 128)
...
def main():
    ...
    train_dataset = TomatoDataset('training\\feature\\')
    test_dataset = TomatoDataset('testing\\feature\\')
